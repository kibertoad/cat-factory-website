...
Surface version **1.43.0**. 111 operations across 21 groups.
...
Next: [Public API](../extend/public-api.md) for the narrative and the worked examples, or [SDKs](../extend/sdks.md) for a generated client that already speaks all of this.
