...
| **Run jobs** | Cloudflare Containers | Self-hosted [runner pool](../operate/runner-pools.md) |
...
conflict-resolver, merger, spec-writer, analysis) need a [runner pool](../operate/runner-pools.md) to
