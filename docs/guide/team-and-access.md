...
![The Account settings panel on its Team & access tab: invite teammates and manage roles, the email sender, and account-scoped provider API keys](/images/app/account-team.webp)
