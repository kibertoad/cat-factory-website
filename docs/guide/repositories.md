...
connects to GitHub through a **GitHub App** and supports linking, bootstrapping, and reconciling
repositories.
...
4. A **service frame materializes** on the board automatically.

This gives every new service a consistent, known-good starting point.
...
Next: pull requirements straight from your trackers — [Issue Sources](./issue-sources.md).
